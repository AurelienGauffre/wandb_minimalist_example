...
DATASET_FRACTION = .2 # take 20% of the dataset
...
def train(config=None):
    ...
    if config is None:
        ...
        wandb.init(project="cifar10_resnet18_subset", config=config) # Add argument name=config.run_name if you want to name the run
    ...
    model = ModifiedResNet18(num_classes=10).to(device)
